...
class Entry {
  ...
  factory Entry.fromJson(Map<String, dynamic> json) {
    ...
    if (entry.id.isEmpty || entry.title.length > 200 || entry.revision < 0)
...
int streak(Iterable<Entry> entries, DateTime now) {
  final days = entries
      .where((e) => e.kind == EntryKind.task && e.done && !e.deleted)
      .map((e) => e.text('completedDay'))
      .toSet();
