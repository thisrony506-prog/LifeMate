...
data class Preferences(val theme: String = "System", val notifications: Boolean = true, val vibration: Boolean = true, val sound: String = "default", val biometric: Boolean = false, val automaticUpdates: Boolean = true, val voiceReminders: Boolean = false)
