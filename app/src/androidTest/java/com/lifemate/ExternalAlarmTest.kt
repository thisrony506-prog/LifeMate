...
class ExternalAlarmTest {
    @Test fun seedPendingAlarmForExternalVerification() = runBlocking {
        ...
        if (args.getString("verifyPrevious") == "true") {
            ...
            // The host verifies the posted notification before restarting instrumentation;
            // starting a new instrumentation process may clear Android notification UI state.
